...
public class ExcelHelper {
    ...
    public void setExcelFile(String excelPath, String sheetName) {
        LogHelper.info("Set Excel File: " + excelPath);
        LogHelper.info("Sheet Name: " + sheetName);
        ...
        try {
            ...
            if (!f.exists()) {
                try {
                    LogHelper.error("File Excel path not found.");
            ...
            if (sheetName.isEmpty()) {
                try {
                    LogHelper.error("The Sheet Name is empty.");
            ...
            if (sheet == null) {
                ...
                try {
                    LogHelper.error("Sheet name not found.");
    ...
    public Object[][] getExcelData(String excelPath, String sheetName) {
        ...
        LogHelper.info("Set Excel file " + excelPath);
        LogHelper.info("Selected Sheet: " + sheetName);
        ...
        try {
            ...
            LogHelper.info("Row: " + (noOfRows - 1) + " - Column: " + noOfCols);
    ...
    public Object[][] getDataHashTable(String excelPath, String sheetName, int startRow, int endRow) {
        LogHelper.info("Excel File: " + excelPath);
        LogHelper.info("Sheet Name: " + sheetName);
        ...
        try {
            ...
            LogHelper.info("Row: " + rows + " - Column: " + columns);
            LogHelper.info("StartRow: " + startRow + " - EndRow: " + endRow);
    ...
    public Object[][] getDataFromSpecificRows(String excelPath, String sheetName, int[] rowNumbers) {
        LogHelper.info("Excel File: " + excelPath);
        LogHelper.info("Sheet Name: " + sheetName);
        LogHelper.info("Reading data from specific rows: " + Arrays.toString(rowNumbers));
        ...
        try {
            ...
            if (sheet == null) {
                LogHelper.info("Sheet name not found.");
                throw new RuntimeException("Sheet name not found.");
            }

            int columns = getColumns();
            LogHelper.info("Column count: " + columns);
            ...
            for (int i = 0; i < rowNumbers.length; i++) {
                ...
                if (rowNum > sheet.getLastRowNum()) {
                    LogHelper.warn("WARNING: Row " + rowNum + " does not exist in the sheet.");
            ...
            LogHelper.error("Exception in getDataFromSpecificRows: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public Object[][] getDataHashTableFromSpecificRows(String excelPath, String sheetName, int[] rowNumbers) {
        ...
        try {
            ...
            LogHelper.error("Exception in getDataHashTableFromSpecificRows: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public void setCellData(String text, int rowNumber, String columnName) {
        try {
            ...
            LogHelper.info("Write data to excel file successfully.");
